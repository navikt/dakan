...
const Viewer = (props: any) => {
    ...
    if (props.match.params.id === 'test') {
        return <Content {...props} indexEntry={exampleJson._source.content} viewerVersion={viewer_version} />;
    }
    ...
    return (
        <React.Fragment>
            ...
            {data && data.content && <Content {...props} indexEntry={data.content} viewerVersion={viewer_version} />}
        </React.Fragment>
    );
};
