...
describe('Test for Content component', () => {
  ...
  //   wrapperInternal = mount(
  //     <Content indexEntry={testContent} viewerVersion="private" />,
  //   )
  ...
  //   expect(
  //     wrapperInternal.contains('Testavdelingen - Seksjon for testing'),
  //   ).toBeTruthy()
  ...
  //   const wrapperStatus = shallow(
  //     <Content indexEntry={ContentWithDeniedStatus} />,
  //   )
  //   expect(
  //     wrapperStatus.contains(
  //       <Heading>Begrepet 'NAV Fagpost' er under arbeid.</Heading>,
  //     ),
  //   ).toBeTruthy()
  // })
})
