...
const Inputs = () => {
    ...
    return (
        <Block>
            ...
            <br />
            <Block marginBottom="scale800">
                <Searchbox value={value} onChange={(e) => setValue(e.target.value)} placeholder="Controlled Input" />
            </Block>
        </Block>
    );
};
...
const IconButtons = () => {
    return (
        <Block display="flex" justifyContent="space-between">
            ...
            <Button kind={KIND.minimal} startEnhancer={<InfoIcon size={24} />} startEnhancerHover={<Alert size={24} />}>
                minimal
            </Button>
...
const Tags = () => {
    ...
    return (
        <React.Fragment>
            ...
            <React.Fragment>
                <Tag color="#4327F1" variant={VARIANT.solid} kind={TAGKIND.custom} onClick={() => {}}>
                    custom
                </Tag>
                <br />
                ...
                <br />
                <Tag color="#4327F1" variant={VARIANT.outlined} kind={TAGKIND.custom} onClick={() => {}}>
                    custom
                </Tag>
                <br />
                <Tag color="black" kind={TAGKIND.custom} closeable={false} backgroundColor={'yellow'}>
                    custom
                </Tag>
                <Tag
                    color="black"
...
const Sliders = () => {
    ...
    return <Slider value={value} onChange={({value}) => value && setValue(value)} />;
};

const Radios = () => {
    const [value, setValue] = React.useState('2');
    return (
        <RadioGroup value={value} onChange={(e) => setValue(e.target.value)} name="number" align={ALIGN.vertical}>
