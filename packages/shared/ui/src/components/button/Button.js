...
export const Button = (props) => {
  ...
  if (props.kind == KIND.secondary)
    themeOverrides = theme && theme.buttonSecondaryOverrides
  if (props.kind == KIND.minimal)
    themeOverrides = theme && theme.buttonMinimalOverrides
