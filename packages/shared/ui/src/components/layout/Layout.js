    ...
    return (
        <Block display="flex" width="100%" minHeight="100vh" flexDirection="column">
            <Block width="100%" paddingLeft={MARGIN_LEFT} paddingRight={MARGIN_RIGHT}>
                ...
                <Block display="flex" justifyContent="center" width="100%">
                    <Block flex="1" width="100%" maxWidth={theme.breakpoints.medium + 'px'}>
                        {props.children}
                    </Block>
                </Block>
            </Block>
...
export const SingleColumn = (props) => {
    ...
    return (
        <React.Fragment>
            <Block display="flex" justifyContent="" width="100%" paddingLeft={PADDING_LEFT}>
                <Block flex="1">
                    <Heading {...props} />
                </Block>
            </Block>

            <Block display="flex" justifyContent="center" width="100%" paddingLeft={PADDING_LEFT}>
        ...
        <React.Fragment>
            ...
            <Block display="flex" justifyContent="center" width="100%">
                <Block
                    ...
                    maxWidth={theme.breakpoints.medium + 'px'}
                >
                    <Block display={['none', 'block']} width={LEFT_MENU_WIDTH} paddingLeft={PADDING_LEFT}>
                        {props.left}
                    </Block>
...
const ThreeCols = (props) => {
    ...
    return (
        <React.Fragment>
            ...
            <Block display="flex" justifyContent="center" width="100%">
                <Block display="flex" justifyContent="center" width="100%" maxWidth={theme.breakpoints.large + 'px'}>
                    <Block display={['none', 'block']} width={LEFT_MENU_WIDTH} paddingLeft={MARGIN_LEFT}>
                        {props.left}
                    </Block>
...
export const LayoutSplit = (props) => {
    ...
    return (
        <React.Fragment>
            <Block display="flex" width="100%" minHeight="100vh" alignItems="flex-start" flexDirection="column">
                <Block display="flex" justifyContent="center" width="100%" paddingLeft={MARGIN_LEFT}>
                    <Block
                        display="flex"
                        justifyContent="flex-start"
                        width="100%"
                ...
                <Block display="flex" justifyContent="center" width="100%" paddingLeft={MARGIN_LEFT}>
                    <Block
                        ...
                        maxWidth={theme.breakpoints.large + 'px'}
                    >
                        <Block display={['none', 'none', 'block']} flex="1" paddingRight="scale800">
                            {props.left}
                        </Block>
                        <Block flex="1" width="100%" paddingRight="scale800">
                            <Block display={['block', 'block', 'none']} flex="1" marginBottom="scale1200">
                                {props.left}
                            </Block>
                            {props.right}
                        </Block>
