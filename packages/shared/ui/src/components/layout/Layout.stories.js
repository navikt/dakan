...
import {Layout, FullWidth, LargeWidth, MediumWidth, LayoutSplit} from './Layout';
...
const checkBoxes = () => {
    return (
        <Block>
            {ITEMS.map((item) => {
                return <StatefulCheckbox onChange={console.log}>{item.subtitle}</StatefulCheckbox>;
            })}
        </Block>
    );
};
...
const item = () => {
    return (
        ...
        >
            ...
            <Paragraph1>
                Proin ut dui sed metus pharetra hend rerit vel non mi. Nulla ornare faucibus ex, non facilisisnisl Proin
                ut dui sed metus pharetra hend rerit vel non mi. Nulla ornare faucibus ex, non facilisisnisl Proin ut
                dui sed metus pharetra hend rerit vel non mi. Nulla ornare faucibus ex, non facilisisnisl
            </Paragraph1>
