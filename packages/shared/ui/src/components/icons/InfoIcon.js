    ...
    return (
        <Icon size={props.size} fill={props.fill}>
            <path
                ...
                fill="#0067C5"
            />
            <path fill-rule="evenodd" clip-rule="evenodd" d="M9 19V17H11V12H9V10H13V17H15V19H9Z" fill="white" />
            <path
                fill-rule="evenodd"
                clip-rule="evenodd"
    ...
    return (
        <Icon size={size} fill={fill}>
            ...
            <path
                ...
                fill="#32414F"
            />
            <path fillRule="evenodd" clipRule="evenodd" d="M9 19V17H11V12H9V10H13V17H15V19H9Z" fill="white" />
            <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M12 5C12.8284 5 13.5 5.67157 13.5 6.5C13.5 7.32843 12.8284 8 12 8C11.1716 8 10.5 7.32843 10.5 6.5C10.5 5.67157 11.1716 5 12 5Z"
