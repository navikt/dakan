...
import {AddIcon, DeleteIcon, DeleteHoverIcon, EditIcon, EditHoverIcon} from '../../components/icons';
    ...
    const getComments = () => {
        return comments.map((comment, index) => {
            return (
                comment &&
                comment.properties && (
                    <Block marginBottom="scale800" padding="scale100" key={'comment_' + index}>
                        <Block display="flex">
                            <Block flex="1">
                                ...
                                <Block $style={{...theme.typography.font300}} marginTop="scale800">
                        ...
                        <Block $style={{border: '1px solid #78706A'}} marginTop="scale400" />
                    </Block>
                )
            );
        });
        ...
        <Block>
            {
                <Block>
                    ...
                    <DeleteCommentModal
                        ...
                        server={server}
                    />
                    <LabelMedium><b>Kommentarer</b></LabelMedium>
                    <Block padding="1em" backgroundColor="#F4F4F4">
                        {comments && comments.length > 0 && (
                            <Block $style={{maxHeight: commentSize, overflowY: 'scroll'}}>{getComments()}</Block>
                        )}
                        {comments && comments.length > 0 && comments[0].properties && (
                            <Block paddingTop="scale400">
                                ...
                                >
                                    <Panel
                                        overrides={{Header: {style: {backgroundColor: '#F4F4F4'}}}}
                                        title={panelTitle}
