...
export const SelectOpplysningstype = (props) => {
    ...
    const deleteTag = (index, tagId) => {
        ...
        axios
            .delete(`${serverUrl}/edge`, {params: {n1: dataId, n2: tagId}, headers: {'JWT-Token': tokenId}})
    ...
    const addTag = (value) => {
        ...
        axios
            .put(`${serverUrl}/edge`, tagPayload, {headers: {'JWT-Token': tokenId}})
            .then(() => setColumnTags(newTags))
            .catch((e) => console.log(e));
    };
                ...
                <React.Fragment>
                    {tag && tag.properties && (
                        <Tag
                            ...
                            onActionClick={() => CheckIfAuthorized(serverUrl, () => deleteTag(index, tag.id))}
                        >
    ...
    const getOptions = () => {
        ...
        return (
            <Select
                ...
                labelKey="name"
                valueKey="name"
                onChange={(tag) => CheckIfAuthorized(serverUrl, () => addTag(tag.value))}
